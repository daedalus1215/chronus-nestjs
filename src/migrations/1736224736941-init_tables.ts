...
export class InitTables1736224736941 implements MigrationInterface {
    name = 'InitTables1736224736941'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "archived_date" date NOT NULL, "memo_id" integer, "checklist_id" integer, "user_id" integer, CONSTRAINT "REL_2d85c0c4df4bdc951cdd0f9465" UNIQUE ("memo_id"), CONSTRAINT "REL_a142a608248254f31569914f79" UNIQUE ("checklist_id"), CONSTRAINT "PK_af6206538ea96c4e77e9f400c3d" PRIMARY KEY ("id"))`);
